...
class _GoodsAndMaterialPage extends State<GoodsAndMaterialPage> {
  ...
  Widget build(BuildContext context) {
    ...
    for(int i=0; i< 10; i++) {
      if(i==1 || i == 6) {
        mockUrl = 'https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/6/28/16b9ebe61ee1bd11~tplv-t2oaga2asx-zoom-in-crop-mark:4536:0:0:0.image';
      } else {
        mockUrl = 'https://chat.openai.com/apple-touch-icon.png';
      }
      waterFallData.add(new WaterFallData('testid-$i', mockUrl, '这时简介部分，只是个最简单的例子，后面需要细化'));
    }
    print('Bulid 方法执行');
    return Scaffold(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Container(
                            ...
                            height: 400,
                            decoration: BoxDecoration(
                              image: DecorationImage(image: NetworkImage('https://alifei05.cfp.cn/creative/vcg/800/version23/VCG21gic6370954.jpg'),fit: BoxFit.cover),
                            ),
                            child: Stack(
                              children: [
                                Container(
                                            ...
                                            children: [
                                              ...
                                              GestureDetector(
                                                ...
                                                child: Container(
                                                    ...
                                                    height: 30,
                                                    decoration: BoxDecoration(
                                                        color: Color.fromRGBO(211, 223, 241, 1),
                            ...
                            child: GridView.count(
                              ...
                              children: List.generate(5, (index) {
                                return Container(
                                  ...
                                  child: Column(
                                      children: [
                                        Image.network('https://chat.openai.com/apple-touch-icon.png',width: 40,),
                                        Padding(
                                          padding: EdgeInsets.only(top: 10),
                                          child: Text('买药', style: TextStyle(fontSize: 14, color: Colors.black),)
                                        )
                                      ]
                                  ),
                                );
                      ...
                      [
                        ...
                        WaterfallFlow.builder(
                          ...
                          gridDelegate: SliverWaterfallFlowDelegateWithFixedCrossAxisCount(
                            ...
                            lastChildLayoutTypeBuilder: (index) => index == waterFallData.length
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            ...
                            icon: Icon(Icons.image, size: 24, color: Colors.black,)
                        )
                      ],
                    ),
                  )
